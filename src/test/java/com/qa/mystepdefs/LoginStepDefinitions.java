...
public class LoginStepDefinitions {
    ...
    @BeforeMethod
	public void setup(){
    	System.setProperty("webdriver.chrome.driver","/Users/Roselin/eclipse-workspace/chromedriver 27");
    ...
    public void i_should_be_logged_in_successfully() {
       AssertJUnit.assertEquals(loginPage.checkLogoutLink(), true);
    }
    ...
    public void i_should_see_an_error_message_indicating(String errorMessage) {
        ...
        AssertJUnit.assertEquals( driver.findElement(By.cssSelector(".alert-danger")).isDisplayed(), true);
    }
